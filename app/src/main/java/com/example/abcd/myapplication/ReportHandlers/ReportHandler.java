package com.example.abcd.myapplication.ReportHandlers;
...
public class ReportHandler
{
	...
	public static Bitmap getScreenshot() {
		//use switch ans shared preferences for more than one activity.
		Activity activity = CRActivity.getForegroundInstance();
		if(activity == null){
			return null;
		}
